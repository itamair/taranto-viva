...
class PopupMessageSubscriber implements EventSubscriberInterface {
  ...
  /**
   * Constructs a new PopupMessageSubscriber object.
   *
  ...
  public function __construct(
    ...
    $this->config = $configFactory->get('popup_message.settings');
  ...
  public function showPopupMessage(ResponseEvent $event) {
    ...
    if ($status && !$system_path) {
      ...
      $popup_message_parameters = [
        ...
        'width' => $this->config->get('width') ?? PopupMessageDefaultValues::POPUP_MESSAGE_DEFAULT_SIZE->value,
        'height' => $this->config->get('height') ?? PopupMessageDefaultValues::POPUP_MESSAGE_DEFAULT_SIZE->value,
