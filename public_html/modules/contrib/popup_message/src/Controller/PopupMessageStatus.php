...
class PopupMessageStatus extends ControllerBase {
  ...
  /**
   * Constructs a new PopupMessageStatus object.
   *
  ...
  public function __construct(
    protected PathMatcherInterface $path_matcher,
  ...
  public function check(Request $request) {
    $config = $this->config_factory->get('popup_message.settings');
    ...
    if ($visibility_pages && $status) {
      ...
      if ($visibility < 2) {
        ...
        $page_match = $this->path_matcher->matchPath($path, $pages);
