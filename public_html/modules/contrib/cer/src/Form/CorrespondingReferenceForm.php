...
class CorrespondingReferenceForm extends EntityForm {
  ...
  public static function create(ContainerInterface $container) {
    /** @var \Drupal\Core\Entity\EntityTypeManagerInterface $entity_query */
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\cer\Entity\CorrespondingReferenceInterface $correspondingReference */
  ...
  /**
   * Helper function for checking reference config entity existence.
   */
