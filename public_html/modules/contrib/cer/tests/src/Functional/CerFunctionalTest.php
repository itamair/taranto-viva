...
namespace Drupal\Tests\cer\Functional;
 ...
 * @group cer
 */
class CerFunctionalTest extends BrowserTestBase {
  ...
  public function testUninstallation() {
    // Go to uninstallation page an uninstall cer:
    $session = $this->assertSession();
    $page = $this->getSession()->getPage();
    $this->drupalGet('/admin/modules/uninstall');
    $session->statusCodeEquals(200);
    $page->checkField('edit-uninstall-cer');
