...
(function($, Drupal) {
  ...
  Drupal.Leaflet.prototype.add_features = function (features, initial) {
    ...
    const absoluteMarkerclusterIconsPath = absoluteBaseUrl + markerclusterIconsPath;

    const svg_icons = {
      '2': '<img src="' + absoluteMarkerclusterIconsPath + 'marker-cluster_orange_2.svg" style="width:30px; height:30px; margin-top:-10px; margin-left:-10px">',
      '3': '<img src="' + absoluteMarkerclusterIconsPath + 'marker-cluster_orange_3.svg" style="width:30px; height:30px; margin-top:-10px; margin-left:-10px">',
      '5': '<img src="' + absoluteMarkerclusterIconsPath + 'marker-cluster_orange_5.svg" style="width:30px; height:30px; margin-top:-10px; margin-left:-10px">',
      '8': '<img src="' + absoluteMarkerclusterIconsPath + 'marker-cluster_orange_8.svg" style="width:30px; height:30px; margin-top:-10px; margin-left:-10px">',
    }
