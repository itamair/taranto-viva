...
((Drupal) => {
  const { isDesktopNav } = Drupal.taranto_viva;
  ...
  Drupal.taranto_viva.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.taranto_viva.isDesktopNav()) return;
  ...
  Drupal.taranto_viva.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.taranto_viva.areAnySubNavsOpen = areAnySubNavsOpen;
