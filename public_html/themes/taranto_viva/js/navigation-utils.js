...
((Drupal) => {
  ...
  Drupal.taranto_viva.isDesktopNav = isDesktopNav;
  ...
  function setStickyHeaderStorage(expandedState) {
    ...
    localStorage.setItem(
      'Drupal.taranto_viva.stickyHeaderState',
      JSON.stringify(item),
    );
  }
  ...
  function getStickyHeaderStorage() {
    ...
    if (now.getTime() > item.expiry) {
      ...
      localStorage.removeItem('Drupal.taranto_viva.stickyHeaderState');
      return false;
    }
    return item.value;
  }
