...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.taranto_viva.areAnySubNavsOpen()) {
          props.taranto_viva.closeAllSubNav();
        } else {
      ...
      if (e.key === 'Tab' && isNavOpen(props.navWrapper)) {
        ...
        if (e.shiftKey) {
          if (
            ...
            !props.taranto_viva.isDesktopNav()
          ) {
    ...
    window.addEventListener('resize', () => {
      if (props.taranto_viva.isDesktopNav()) {
        toggleNav(props, false);
      ...
      Drupal.taranto_viva.closeAllSubNav();
    });
   ...
   */
  Drupal.behaviors.taranto_vivaNavigation = {
    attach(context) {
