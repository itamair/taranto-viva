...
namespace Drupal\taranto_viva;

use Drupal\Core\Security\TrustedCallbackInterface;

/**
 * Implements trusted prerender callbacks for the Taranto Viva theme.
 *
 * @internal
 */
class TarantoVivaPreRender implements TrustedCallbackInterface {
